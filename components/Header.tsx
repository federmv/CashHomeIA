        ...
        <header className="bg-brand-secondary/50 backdrop-blur-sm sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    ...
                    <nav className="flex items-center space-x-2 sm:space-x-4 bg-brand-primary p-2 rounded-xl">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="text-right hidden sm:block">
                           <p className="text-sm text-white font-semibold truncate">{user.displayName || user.email}</p>
                        </div>
                        <button
                            onClick={handleSignOut}
                            className="bg-brand-secondary border border-brand-secondary/50 text-white text-sm rounded-lg px-4 py-2 transition hover:bg-red-500/50"
                        >
                            {t('header.logout')}
                        </button>
                    </div>
